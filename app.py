...
st.write('## SAKURAとは')
st.write('お客様の声を簡単に解析するSAKURAは、テキストファイル（CSV 形式）をブラウザからアップロードすることで、AI 機能を用いた自動解析が可能なサービスです。口コミやアンケート、問合せなどから注目すべきキーワードを探します。')
st.write('顧客ニーズの調査や自社の課題解決、サービス改善などにお役立てください。')
